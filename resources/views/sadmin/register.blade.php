...
<div class="container">
                        ...
                        <h1><b>Super Admin</b> <small><b>Register here</b></small></h1>
                        </div>
                        </center>
                        </div>
<form class="well form-horizontal" action="/sadmin-register" method="POST">
{{csrf_field()}}
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="ssn" name="ssn" placeholder="Social Security Number" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="email" name="email" placeholder="E-mail" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="username" name="username" placeholder="Username" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                      ...
                      <fieldset>
                        ...
                        <h4><b>Financial Informations</b><small>(Mandatory)</small></h4>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="fixed_allowances" name="fixed_allowances" placeholder="Fixed Allowances" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="fixed_deductions" name="fixed_deductions" placeholder="Fixed Deductions" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input id="acc" name="acc" placeholder="Account Number" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                      ...
                      <fieldset>
                        ...
                        <h4><b>Basic Informations</b><small>(optional)</small></h4>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="last_name" name="last_name" placeholder="Last Name" class="form-control"  value="" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input id="dob" name="dob" placeholder="Date Of Birth" class="form-control"  value="" type="date"></div>
                            </div>
                         </div>
                         <div class="form-group">
